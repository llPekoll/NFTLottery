...
<section class="px-20 py-10">
	<div class="float-left text-3xl font-semibold italic pt-2">$NFTL</div>
	<div class="float-right flex">
		<div class="rounded-full border-4 border-amber-900 p-2 bg-white z-10">
		...
		<button on:click={connectWallet}>
			<div
				class="text-xl font-semibold rounded-full border-4 border-amber-900 px-10 h-10 mt-2 -ml-8 z-0"
			>
				<p class="">
					{amount}
				</p>
